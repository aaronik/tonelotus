...
ToneLotus.prefetchTones = function(){
	new Howl({ urls: ['audios/fm_synth/c6.mp3'] });
	new Howl({ urls: ['audios/fm_synth/a5.mp3'] });
	new Howl({ urls: ['audios/fm_synth/g5.mp3'] });
	new Howl({ urls: ['audios/fm_synth/e5.mp3'] });
	new Howl({ urls: ['audios/fm_synth/d5.mp3'] });
	new Howl({ urls: ['audios/fm_synth/c5.mp3'] });
	new Howl({ urls: ['audios/fm_synth/a4.mp3'] });
	new Howl({ urls: ['audios/fm_synth/g4.mp3'] });
	new Howl({ urls: ['audios/fm_synth/e4.mp3'] });
	new Howl({ urls: ['audios/fm_synth/d4.mp3'] });
	new Howl({ urls: ['audios/fm_synth/c4.mp3'] });
	new Howl({ urls: ['audios/fm_synth/a3.mp3'] });
	new Howl({ urls: ['audios/fm_synth/g3.mp3'] });
	new Howl({ urls: ['audios/fm_synth/e3.mp3'] });
	new Howl({ urls: ['audios/fm_synth/d3.mp3'] });

	new Howl({ urls: ['audios/drumkit_1/woodblock.mp3'] });
	new Howl({ urls: ['audios/drumkit_1/tom6.mp3'] });
	new Howl({ urls: ['audios/drumkit_1/tom5.mp3'] });
	new Howl({ urls: ['audios/drumkit_1/tom4.mp3'] });
	new Howl({ urls: ['audios/drumkit_1/tom3.mp3'] });
	new Howl({ urls: ['audios/drumkit_1/tom2.mp3'] });
	new Howl({ urls: ['audios/drumkit_1/tom1.mp3'] });
	new Howl({ urls: ['audios/drumkit_1/hh_open.mp3'] });
	new Howl({ urls: ['audios/drumkit_1/hh_loose.mp3'] });
	new Howl({ urls: ['audios/drumkit_1/hh_closed.mp3'] });
	new Howl({ urls: ['audios/drumkit_1/snare.mp3'] });
	new Howl({ urls: ['audios/drumkit_1/block_snare.mp3'] });
	new Howl({ urls: ['audios/drumkit_1/floor.mp3'] });
	new Howl({ urls: ['audios/drumkit_1/kick.mp3'] });
	new Howl({ urls: ['audios/drumkit_1/bass_snare.mp3'] });
	new Howl({ urls: ['audios/drumkit_1/bass.mp3'] });

	new Howl({ urls: ['audios/sine_pad/c6.mp3'] });
	new Howl({ urls: ['audios/sine_pad/a5.mp3'] });
	new Howl({ urls: ['audios/sine_pad/g5.mp3'] });
	new Howl({ urls: ['audios/sine_pad/e5.mp3'] });
	new Howl({ urls: ['audios/sine_pad/d5.mp3'] });
	new Howl({ urls: ['audios/sine_pad/c5.mp3'] });
	new Howl({ urls: ['audios/sine_pad/a4.mp3'] });
	new Howl({ urls: ['audios/sine_pad/g4.mp3'] });
	new Howl({ urls: ['audios/sine_pad/e4.mp3'] });
	new Howl({ urls: ['audios/sine_pad/d4.mp3'] });
	new Howl({ urls: ['audios/sine_pad/c4.mp3'] });
	new Howl({ urls: ['audios/sine_pad/a3.mp3'] });
	new Howl({ urls: ['audios/sine_pad/g3.mp3'] });
	new Howl({ urls: ['audios/sine_pad/e3.mp3'] });
	new Howl({ urls: ['audios/sine_pad/d3.mp3'] });
	new Howl({ urls: ['audios/sine_pad/c3.mp3'] });		
}
